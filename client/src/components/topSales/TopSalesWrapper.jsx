...
export default function TopSalesWrapper({ category, limit }) {
  ...
  return (
    <div className="mx-auto mt-0 mb-3 lg:mb-6 w-full lg:w-11/12 bg-white">
      <h1 className="
      text-center
      pt-6
      text-lg
      ...
      {loadingTopSales ? (
        ...
        <section className="text-gray-600 body-font w-full px-auto lg:px-8 overflow-x-scroll lg:overflow-hidden">
          ...
          <div className="container py-6 mx-none lg:mx-auto w-full">
            <div className="flex flex-row flex-nowrap justify-between content-stretch ">
